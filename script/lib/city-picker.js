...
(function (factory) {
    ...
    if (typeof ChineseDistricts === 'undefined') {
        throw new Error('The file "ChineseDistricts.js" must be included first!');
    }
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:90%;' +
        ...
        bind: function () {
            ...
            this.$element.on('change', (this._changeElement = $.proxy(this.changeFn, this))).on('focus', (this._focusElement = $.proxy(function () {
                this.needBlur = true;
                this.open();
        ...
        feedVal: function () {
            this.$element.off("change",this.changeFn);
            this.$element.change();
            this.$element.val(this.getVal());
            this.$element.on("change",this.changeFn);
