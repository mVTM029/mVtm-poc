define(['app/views/baseController','app/util/util','app/xfs/ESpaceMediaTerminal','jquery','app/util/router','app/views/dialog/dialog','./kindly.model','app/xfs/Common'], function (Base,$$,Terminal,$,router,dialog,model,Common) {
